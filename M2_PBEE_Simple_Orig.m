...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [Sa, EDP, pd_C, paramNC, fragS, DamageProb, SaCalc, EL_PP, EL_case, EAL_S, EAL_NS, EAL_C] = M2_PBEE_Simple_Orig(struc, EDP_c, Years)
%%%Note%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if strcmp(struc,'conc')
    ...
    Sa = importdata('Data/Sa_conc.mat');
    %roof drift values
    EDP = importdata('Data/EDP_conc.mat');
else
    Sa = importdata('Data/Sa_steel.mat');
    EDP = importdata('Data/EDP_steel.mat');
...
EL_PP = EAL_PP*Years;
EL_case    = EAL([1,4,5,6,7,2,3,8,9])*Years;
end
